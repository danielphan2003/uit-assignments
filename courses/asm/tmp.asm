...
reverse:
  ...
  reverse_loop:
    add $t3, $t1, $t0  # $t1 is the base address for our 'input' array, add loop index
    ...
    jal capitalize
    move $t4, $v0
    sb $t4, output($t2)  # Overwrite this byte address in memory

    subi $t2, $t2, 1  # Subtract our overall string length by 1 (j--)
